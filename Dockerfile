...
# Download matching versions of Chromium and ChromeDriver
RUN curl -Lo "/tmp/chromedriver.zip" "https://chromedriver.storage.googleapis.com/98.0.4758.102/chromedriver_linux64.zip" && \
...
RUN apt-get update && apt-get install -y \
    ...
    dbus libdbus-glib-1-2 libnss3 libgbm1 \
    && apt-get clean && rm -rf /var/lib/apt/lists/*
